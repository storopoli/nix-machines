...
let
  authorizedKeys = [
    ...
    "ecdsa-sha2-nistp256 AAAAE2VjZHNhLXNoYTItbmlzdHAyNTYAAAAIbmlzdHAyNTYAAABBBDcO5oBYVfWsI1aHVgr7HEDP88ykgJijOS3p5RNRdd3VcoOA3wfzmfiY0KdQH8KbHDUhmyic3TVt69pqBxqPlAk= ssh@secretive.macbook.local"
  ];
in
{
  services = {
